...
public class BLEScanActivity extends AppCompatActivity implements View.OnClickListener, IronbotSearcherCallback {
    ...
    private void initView() {
        ...
        mAdapter = new BLEAdapter(this, items, mSearcher);
