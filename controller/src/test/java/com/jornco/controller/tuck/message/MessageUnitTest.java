    ...
    public void init() {
        ...
        msgs.add(
                new MsgBean(
                        ...
                        new byte[]{0x24, 0x2a, 0x24, 0x10, 0x00, 0x06, 0x01, 0x01, 0x01, 0x50, 0x01, 0x33, 0x23, 0x2a, 0x23, (byte) 0x7f}
                )
        );

        msgs.add(
                new MsgBean(
                        BLEConstant.CMD_DOWNLOAD_SCRIPT,
                        new byte[][]{new byte[]{0x01}, new byte[]{0x01}, new byte[]{0x13, 0x12}},
                        new byte[]{0x24, 0x2a, 0x24, 0x11, 0x00, 0x09, 0x01, 0x01, 0x01, 0x01, 0x02, 0x13, 0x12, 0x23, 0x2a, 0x23, 0x27}
                )
        );

        msgs.add(
                new MsgBean(
                        BLEConstant.CMD_DOWNLOAD_TMP_SCRIPT,
                        new byte[][]{new byte[]{0x01}, new byte[]{0x13, 0x12}},
                        new byte[]{0x24, 0x2a, 0x24, 0x0F, 0x00, 0x0b, 0x01, 0x01, 0x02, 0x13, 0x12, 0x23, 0x2a, 0x23, 0x25}
                )
        );
    }
